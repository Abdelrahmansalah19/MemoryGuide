...
<!-- ======================= About section =====================-->
              ...
              <div class="col-lg-6 col-12">
                  <div class="custom-text-box">
                      ...
                      <h5 class="mb-3">Memory Guide , We care about you being healthy</h5>

         <p class="mb-0">If you or a loved one needs support, there are many programs and resources available to you:</p>
                  </div>
